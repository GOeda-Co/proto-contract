// Code generated by protoc-gen-go-grpc. DO NOT EDIT. OK
// versions:
...
type DeckServiceClient interface {
	...
	ReadAllDecks(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*DeckListResponse, error)
...
func (c *deckServiceClient) ReadAllDecks(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*DeckListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type DeckServiceServer interface {
	...
	ReadAllDecks(context.Context, *UserRequest) (*DeckListResponse, error)
...
func (UnimplementedDeckServiceServer) ReadAllDecks(context.Context, *UserRequest) (*DeckListResponse, error) {
...
func _DeckService_ReadAllDecks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeckServiceServer).ReadAllDecks(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
